    ...
    <Container maxWidth="xs" sx={{ py: 12 }}>
      ...
      >
        ...
        <Typography variant="body2" sx={{ color: "#94a3b8", mb: 3, textAlign: "center" }}>
          Sign in to access your ShopHub account
        </Typography>
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ width: "100%", display: "flex", flexDirection: "column", gap: 2 }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", mt: 2 }}>
            <Typography variant="body2" sx={{ color: "#94a3b8" }}>
              ...
              <Link component={RouterLink} to="/register" sx={{ color: "#818cf8", fontWeight: 600, textDecoration: "none" }}>
                Sign Up
              </Link>
            </Typography>
          </Box>
...
// Internal component for visual lock icon glow
const AvatarGlow = () => (
  <Box
    sx={{
      width: 48,
